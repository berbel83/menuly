...
export default function MealRow({
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-3 overflow-hidden rounded-[15px] bg-white px-3 py-2.5 text-left shadow-[0_4px_14px_rgba(42,60,44,0.05)] ring-1 ring-[#DFE6DD] transition active:scale-[0.995]"
    >
      <div
